...
#ifndef __CLOUDIUS_Q_H__
#define __CLOUDIUS_Q_H__

#include "queue-mpsc.h"                                      /* Cloudius Queue       */
#define QUEUE_NAME "Cloudius Queue"
typedef lockfree::queue_mpsc<work_node_t>   Q_t;
